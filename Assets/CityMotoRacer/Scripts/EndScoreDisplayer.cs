...
public class EndScoreDisplayer : MonoBehaviour {
	...
	{
		iTween.ValueTo(gameObject,iTween.Hash("from",0,"to", GamePlayController.end_time,"time",1,"easetype",iTween.EaseType.easeInOutCubic,
	...
	{
		SoundController.Static.playCoinHit();
		distancetext.text = ""+ Mathf.RoundToInt(  newValue )+"s";
